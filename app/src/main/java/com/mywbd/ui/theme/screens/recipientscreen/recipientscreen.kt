package com.mywbd.ui.theme.screens.recipientscreen
...
import com.mywbd.navigation.ROUTE_MATCH
import com.mywbd.ui.theme.screens.donorscreen.donor_screen

@Composable
fun recipient_screen(navController: NavHostController) {
...

    {
        ...
        Text(text = "Click here to continue",
            fontFamily = FontFamily.Cursive,
            modifier = Modifier.clickable {navController.navigate(ROUTE_MATCH) })
...
@Preview
@Composable
private fun recipient_preview() {
    recipient_screen(rememberNavController())
}